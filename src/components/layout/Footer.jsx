...
export default function Footer() {
  return (
    <footer
      id="contact"
      className="bg-white border-t border-gray-100 pt-20 pb-8"
    >
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 leading-relaxed mb-5">
              Pakistan's top real estate investment platform. Your trusted
              partner from plot to home.
            </p>
            ...
            <ul className="space-y-3">
              {NAV_LINKS.map((link) => (
                <li key={link.href}>
                  <Link
                    to={link.href}
                    className="text-sm text-gray-500 hover:text-gold-dark transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-400">
            © 2024 Five Star Estate. All rights reserved.
          </p>
          <div className="flex gap-6">
            <a
              href="#"
              className="text-xs text-gray-400 hover:text-gold-dark transition-colors"
            >
              Privacy Policy
            </a>
            <a
