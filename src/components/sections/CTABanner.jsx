...
export default function CTABanner() {
  ...
  return (
    <section className="py-20 bg-navy relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,rgba(201,168,76,0.1),transparent_60%)]" />
      ...
      <div ref={ref} className="reveal max-w-[800px] mx-auto px-6 text-center relative z-10">
        ...
        <a
          href="#contact"
          className="inline-flex items-center gap-2.5 px-10 py-4 bg-gold text-navy font-bold text-sm rounded hover:bg-gold-dark hover:-translate-y-1 hover:shadow-xl hover:shadow-gold/30 transition-all duration-300"
        >
